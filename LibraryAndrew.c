...
void LoadAllTextures()
{
    ...
    Character.PlayerFrontSprite = LoadTexture("Assets/chickenlittlefront.png");
    Character.PlayerBackSprite = LoadTexture("Assets/chickenlittleback.png");
    Character.PlayerSideLeftSprite = LoadTexture("Assets/chickenlittlesideleft.png");
    Character.PlayerSideRightSprite = LoadTexture("Assets/chickenlittlesideright.png");
    background = LoadTexture("Assets/mapproyek2.png");
    logs = LoadTexture("Assets/logbridge.png");
    Train = LoadTexture("Assets/KAI.png");
    ...
    lvl3background = LoadTexture("Assets/map2proyek3.png");
    for (int i = 0; i<4; i++)
    {
        sprintf(filename, "Assets/FlagAnim/checkpointflagassprite%i.png", i+1);
        FlagAsset[i] = LoadTexture(filename);
    }
    for (int i = 0; i<6; i++)
    {
        sprintf(filename, "Assets/PointsAnim/pointsup%i.png", i+1);
        PointAsset[i] = LoadTexture(filename);
    }
    for (int i = 0; i<6; i++)
    {
        sprintf(filename, "Assets/HealthAnim/health%i.png", i+1);
